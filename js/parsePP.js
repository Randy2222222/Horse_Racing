...
const RACETYPE_REGEX = /^((?:[Ⓕ🅂])(?:[A-Za-z ]+\d{1,9}\-\'\_[A-Za-z]?))$/g;
// 9️⃣ Class Rating
...
// ---------------------------
   ...
   /(Ⓕ|🅂|Alw\d+|A\d+k|G\d|PuckerUp|QEIICup|DGOaks|[A-Za-z]+\s\d+k|[A-Z][a-z]+\-G\d|Mdn\s+\d+k|OC\d+k)/g);
            if (raceTypeM) {
